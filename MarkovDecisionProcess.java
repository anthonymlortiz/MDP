   ...
   int rows, columns;
    ...
    public void initiateMDP() { // HardCoded MDP from HW
        ...
        */
        ...
        actionTable[0][0][1] = new Transition(1/3, allStates[1], 2);
        actionTable[0][1][2] = new Transition(1/3, allStates[2], 0);
        actionTable[0][1][3] = new Transition(1/3, allStates[3], -1);
        actionTable[1][0][7] = new Transition(1/2, allStates[7], 2);
        actionTable[1][0][4] = new Transition(1/2, allStates[4], 0);
        actionTable[2][0][4] = new Transition(1/6, allStates[4], 2);
        actionTable[2][0][7] = new Transition(1/6, allStates[7], 2);
        actionTable[2][1][4] = new Transition(1/3, allStates[4], 0);
        actionTable[2][2][5] = new Transition(1/3, allStates[5], -1);
        actionTable[3][0][5] = new Transition(1/6, allStates[5], 2);
        actionTable[3][0][8] = new Transition(1/6, allStates[8], 2);
        actionTable[3][1][5] = new Transition(1/2, allStates[5], 0);
        actionTable[4][0][6] = new Transition(1/3, allStates[6], 2);
        actionTable[4][1][7] = new Transition(1/3, allStates[7], 0);
        actionTable[4][2][8] = new Transition(1/3, allStates[8], -1);
        actionTable[5][0][9] = new Transition(1/2, allStates[9], 2);
        actionTable[5][1][8] = new Transition(1/2, allStates[8], 0);
        actionTable[6][0][10] = new Transition(1/3, allStates[10], -1);
        actionTable[6][1][10] = new Transition(1/3, allStates[10], -1);
        actionTable[6][2][10] = new Transition(1/3, allStates[10], -1);
        actionTable[7][0][10] = new Transition(1/3, allStates[10], 0);
        actionTable[7][1][10] = new Transition(1/3, allStates[10], 0);
        actionTable[7][2][10] = new Transition(1/3, allStates[10], 0);
        actionTable[8][0][10] = new Transition(1/3, allStates[10], 4);
        actionTable[8][1][10] = new Transition(1/3, allStates[10], 4);
        actionTable[8][2][10] = new Transition(1/3, allStates[10], 4);
        actionTable[9][0][10] = new Transition(1/3, allStates[10], 3);
        actionTable[9][1][10] = new Transition(1/3, allStates[10], 3);
        actionTable[9][2][10] = new Transition(1/3, allStates[10], 3);
